...
test("Deve retornar status 200 e un JSON no GET", async function () {
...
test("Deve retornar status 422 e un JSON no POST", async function () {
...
test("Deve retornar status 404 e un JSON no PUT", async function () {
...
test("Deve retornar status 404 e un JSON no DELETE", async function () {
